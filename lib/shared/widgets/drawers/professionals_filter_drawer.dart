...
class ProfessionalsFilterDrawer extends StatefulWidget {
  const ProfessionalsFilterDrawer({super.key});

  @override
  State<ProfessionalsFilterDrawer> createState() =>
      _ProfessionalsFilterDrawerState();
}

class _ProfessionalsFilterDrawerState extends State<ProfessionalsFilterDrawer> {
  @override
